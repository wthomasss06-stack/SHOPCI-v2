...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'Le paiement à la livraison est-il sécurisé ?', a: 'Le principe du paiement à la livraison vous protège déjà : vous ne payez qu\'au moment où vous avez le produit entre les mains, jamais avant. Vous pouvez donc vérifier l\'article avant de remettre l\'argent. La commande n\'est marquée \"livrée\" qu\'après votre confirmation, ce qui garde une trace en cas de litige.' },
