  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: 22, fontWeight: 800, margin: '0 0 8px' }}>Bon retour</h1>
        <p style={{ fontSize: 14, color: dark ? '#a1a1aa' : '#6b7280', margin: '0 0 28px', lineHeight: 1.5 }}>
          Connecte-toi avec ton compte Google pour acheter ou vendre sur ShopCI.
        </p>

        {authError && (
          <div style={{
            background: 'rgba(239,68,68,.1)', border: '1px solid rgba(239,68,68,.3)',
            color: '#ef4444', borderRadius: 10, padding: '10px 14px', fontSize: 13,
